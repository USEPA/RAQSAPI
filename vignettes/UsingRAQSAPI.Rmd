...
To retrieve the keyring to use with RAQSAPI load the keyring package and use the
function key_get to return the user credential to RAQSAPI:
...
to change the keyring stored with the keyring package repeat the steps above to
call the keyring::key_set function again with the new credential information.
