...
## RAQSAPI 2.0.6
 ...
 - Many improvement to project code thanks to rOpenSci Review by Milan Malfait,
   Rainer M Krug and Mark Padgham
 - RAQSAPI no longer stores credential information in the R global environment, 
   instead credentials are stored in a private package environment.
