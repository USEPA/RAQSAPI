...
[![Last-changedate](https://img.shields.io/badge/last%20change-%202026--04--27-yellowgreen.svg)](/commits/master)
...
Then use the package `pak` to install the latest stable version of
RAQSAPI from CRAN
...
huge undertaking, documentation is often overlooked and not given proper
attention to. We thank you for your efforts.
