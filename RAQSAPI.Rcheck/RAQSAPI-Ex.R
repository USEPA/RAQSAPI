...
cleanEx()
nameEx("aqs_qa_annualperformanceeval_by_MA")
### * aqs_qa_annualperformanceeval_by_MA

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceeval_by_MA
### Title: aqs_qa_annualperformanceeval_by_MA
### Aliases: aqs_qa_annualperformanceeval_by_MA
...
### ** Examples
          ...
          ## Not run: 
##D aqs_qa_annualperformanceeval_by_MA(parameter = "44201",
##D                                                   bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                   edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceeval_by_MA", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceeval_by_county")
### * aqs_qa_annualperformanceeval_by_county

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceeval_by_county
### Title: aqs_qa_annualperformanceeval_by_county
### Aliases: aqs_qa_annualperformanceeval_by_county
...
# Returns a tibble containing annual performance evaluation data
 ...
 ## Not run: 
##D  aqs_qa_annualperformanceeval_by_county(parameter = "44201",
##D                                                   bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                   edate = as.Date("20171231",
##D                                                            format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceeval_by_county", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceeval_by_pqao")
### * aqs_qa_annualperformanceeval_by_pqao

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceeval_by_pqao
### Title: aqs_qa_annualperformanceeval_by_pqao
### Aliases: aqs_qa_annualperformanceeval_by_pqao
...
# Returns a tibble containing annual performance evaluation data
 ...
 ## Not run: 
##D  aqs_qa_annualperformanceeval_by_pqao(parameter = "44201",
##D                                                 bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                 edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceeval_by_pqao", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceeval_by_site")
### * aqs_qa_annualperformanceeval_by_site

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceeval_by_site
### Title: aqs_qa_annualperformanceeval_by_site
### Aliases: aqs_qa_annualperformanceeval_by_site
...
#Returns a tibble containing annual performance evaluation data for
 ...
 ## Not run: 
##D   aqs_qa_annualperformanceeval_by_site(parameter = "44201",
##D                                                  bdate = as.Date("20170101",
##D                                                          format = "%Y%m%d"),
##D                                                  edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceeval_by_site", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceeval_by_state")
### * aqs_qa_annualperformanceeval_by_state

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceeval_by_state
### Title: aqs_qa_annualperformanceeval_by_state
### Aliases: aqs_qa_annualperformanceeval_by_state
...
# Returns a tibble containing annual performance evaluation
 ...
 ## Not run: 
##D  aqs_qa_annualperformanceeval_by_state(parameter = "44201",
##D                                                   bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                   edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceeval_by_state", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceevaltransaction_by_MA")
### * aqs_qa_annualperformanceevaltransaction_by_MA

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceevaltransaction_by_MA
### Title: aqs_qa_annualperformanceevaltransaction_by_MA
### Aliases: aqs_qa_annualperformanceevaltransaction_by_MA
...
# Returns a tibble containing annual performance evaluation data
 ...
 ## Not run: 
##D aqs_qa_annualperformanceevaltransaction_by_MA(parameter = "44201",
##D                                                   bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                   edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceevaltransaction_by_MA", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceevaltransaction_by_county")
### * aqs_qa_annualperformanceevaltransaction_by_county

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceevaltransaction_by_county
### Title: aqs_qa_annualperformanceevaltransaction_by_site
### Aliases: aqs_qa_annualperformanceevaltransaction_by_county
...
# Returns a tibble containing annual performance evaluation data
          # (raw) for ozone in Baldwin County, AL for 2017 in RD format.
 ## Not run: 
##D aqs_qa_annualperformanceevaltransaction_by_county(parameter = "44201",
##D                                                   bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                   edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceevaltransaction_by_county", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceevaltransaction_by_pqao")
### * aqs_qa_annualperformanceevaltransaction_by_pqao

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceevaltransaction_by_pqao
### Title: aqs_qa_annualperformanceevaltransaction_by_pqao
### Aliases: aqs_qa_annualperformanceevaltransaction_by_pqao
...
#Returns a tibble containing annual performance evaluation data for
 ...
 ## Not run: 
##D aqs_qa_annualperformanceevaltransaction_by_pqao(parameter =
##D                                                                      "44201",
##D                                                 bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                 edate = as.Date("20171231",
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceevaltransaction_by_pqao", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceevaltransaction_by_site")
### * aqs_qa_annualperformanceevaltransaction_by_site

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceevaltransaction_by_site
### Title: aqs_qa_annualperformanceevaltransaction_by_site
### Aliases: aqs_qa_annualperformanceevaltransaction_by_site
...
#Returns a tibble containing annual performance evaluation data
          ...
          # 2017 in RD format.
## Not run: 
##D aqs_qa_annualperformanceevaltransaction_by_site(parameter = "44201",
##D                                                   bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                   edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceevaltransaction_by_site", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_qa_annualperformanceevaltransaction_by_state")
### * aqs_qa_annualperformanceevaltransaction_by_state

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_qa_annualperformanceevaltransaction_by_state
...
## Not run: 
##D         aqs_qa_annualperformanceevaltransaction_by_state(parameter = "44201",
##D                                                   bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                   edate = as.Date("20171231",
##D                                                            format = "%Y%m%d")
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_qa_annualperformanceevaltransaction_by_state", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
cleanEx()
nameEx("aqs_quarterlysummary_by_box")
### * aqs_quarterlysummary_by_box

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_quarterlysummary_by_box
### Title: aqs_quarterlysummary_by_box
### Aliases: aqs_quarterlysummary_by_box
...
# Returns a tibble containing ozone quarterly summaries
          ...
          #  between 2015 - 2017
          ## Not run: 
##D aqs_quarterlysummary_by_box(parameter = "44201",
##D                                                bdate = as.Date("20150101",
##D                                                           format = "%Y%m%d"),
##D                                                edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_quarterlysummary_by_box", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_quarterlysummary_by_cbsa")
### * aqs_quarterlysummary_by_cbsa

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_quarterlysummary_by_cbsa
...
# Returns a tibble of $NO_{2}$ quartyerly summary
          ...
          ## Not run: 
##D aqs_quarterlysummary_by_cbsa(parameter = "42602",
##D                                                 bdate = as.Date("20170101",
##D                                                           format = "%Y%m%d"),
##D                                                 edate = as.Date("20171231",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_quarterlysummary_by_cbsa", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_quarterlysummary_by_county")
### * aqs_quarterlysummary_by_county

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_quarterlysummary_by_county
### Title: aqs_quarterlysummary_by_county
### Aliases: aqs_quarterlysummary_by_county
...
# returns a tibble containing quarterly summaries for
 ...
 ## Not run: 
##D aqs_quarterlysummary_by_county(parameter = "88101",
##D                                          bdate = as.Date("20160101",
##D                                                           format = "%Y%m%d"),
##D                                          edate = as.Date("20170228",
##D                                                           format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_quarterlysummary_by_county", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_quarterlysummary_by_site")
### * aqs_quarterlysummary_by_site

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_quarterlysummary_by_site
### Title: aqs_quarterlysummary_by_site
### Aliases: aqs_quarterlysummary_by_site
...
# returns a tibble containing quarterly summaries for
 ...
 ## Not run: 
##D aqs_quarterlysummary_by_site(parameter = "88101",
##D                                        bdate = as.Date("20160101",
##D                                                        format = "%Y%m%d"),
##D                                        edate = as.Date("20160331",
##D                                                        format = "%Y%m%d"),
##D                                        stateFIPS = "37",
##D                                        countycode = "183",
##D                                        sitenum = "0014"
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_quarterlysummary_by_site", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_quarterlysummary_by_state")
### * aqs_quarterlysummary_by_state

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_quarterlysummary_by_state
### Title: aqs_quarterlysummary_by_state
### Aliases: aqs_quarterlysummary_by_state
...
# Returns an aqs S3 object containing quarterly summaries for
 ...
 ## Not run: 
##D aqs_quarterlysummary_by_state(parameter = "88101",
##D                                         bdate = as.Date("20160101",
##D                                                         format = "%Y%m%d"),
##D                                         edate = as.Date("20171231",
##D                                                         format = "%Y%m%d"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_quarterlysummary_by_state", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
cleanEx()
nameEx("aqs_sampledurations")
### * aqs_sampledurations

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: aqs_sampledurations
### Title: aqs_sampledurations
### Aliases: aqs_sampledurations
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("aqs_sampledurations", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("aqs_sign_up")
### * aqs_sign_up
...
##D                    #   Wake County, NC between on Feb 28, 2016.
...
#Returns a AQS_Data Mart_APIv2 S3 object of
         ## Not run: 
##D  # Returns a tibble containing benzene transaction sample
##D                    # data for North Carolina on May 15, 1995
